...
DWORD TInput::KeyCheck(DWORD dwKey)
{
	...
	//1000 0000 0000 0000	=> 0x8000(이전 X ~ 지금  0) 이전 누른적 없고 지금은 눌러졌다.(KEY_PUSH)
	//1000 0000 0000 0001	=> 0x8001(이전 0 ~ 지금  0) 이전 눌러져있고 지금도 눌러져있다.(KEY_HOLD)
	//0000 0000 0000 0000	=> 0x0000(이전 X ~ 지금  X) 이전도 눌러져있지 않고 지금도 눌러져있지 않다.(KEY_FREE) 
	//0000 0000 0000 0001	=> 0x0001(이전 0 ~ 지금  X) 이전 눌러져있고 지금은 눌러져있지 않다.(KEY_UP)
